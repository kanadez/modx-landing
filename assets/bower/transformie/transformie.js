...
var Transformie = {
	...
	track: function(query) {
		...
		if (el.addEventListener) {
		    ...
		    el.addEventListener('propertychange', function(e) {checkTransform(e, el)});
		} else if (el.attachEvent) {
			el.detachEvent('onpropertychange');
		    el.attachEvent('onpropertychange', function(e) {checkTransform(e, el)});
		}

		function checkTransform(e, el) {
			if(e.originalEvent.propertyName == 'style.webkitTransform' || e.originalEvent.propertyName == 'style.MozTransform' || e.originalEvent.propertyName == 'style.transform')
	        	Transformie.applyMatrixToElement(Transformie.computeMatrix(Transformie.getTransformValue(el.style)), el);
		}
	},
