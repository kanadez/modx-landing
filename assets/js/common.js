...
(function () {
  ...
  14: [function (_dereq_, module, exports) {
    ...
    var at = _dereq_(105)(true); // `AdvanceStringIndex` abstract operation
  ...
  37: [function (_dereq_, module, exports) {
    ...
    var document = _dereq_(46).document; // typeof document.createElement is 'object' in old IE
  ...
  50: [function (_dereq_, module, exports) {
    module.exports = !_dereq_(36) && !_dereq_(42)(function () {
      return Object.defineProperty(_dereq_(37)('div'), 'a', {
        get: function get() {
          return 7;
        }
      }).a != 7;
  ...
  53: [function (_dereq_, module, exports) {
    ...
    var cof = _dereq_(26); // eslint-disable-next-line no-prototype-builtins
  ...
  60: [function (_dereq_, module, exports) {
    ...
    _dereq_(48)(IteratorPrototype, _dereq_(128)('iterator'), function () {
      return this;
    });
  ...
  105: [function (_dereq_, module, exports) {
    ...
    var defined = _dereq_(35); // true  -> String#at
  ...
  119: [function (_dereq_, module, exports) {
    ...
    var isObject = _dereq_(57); // instead of the ES6 spec version, we didn't implement @@toPrimitive case
  ...
  137: [function (_dereq_, module, exports) {
    ...
    $export($export.S + $export.F * !_dereq_(62)(function (iter) {
      Array.from(iter);
    }), 'Array', {
  ...
  140: [function (_dereq_, module, exports) {
    ...
    var toIObject = _dereq_(116); // 22.1.3.4 Array.prototype.entries()
  ...
  144: [function (_dereq_, module, exports) {
    ...
    var createProperty = _dereq_(31); // WebKit Array.of isn't generic
  ...
  152: [function (_dereq_, module, exports) {
    ...
    var toISOString = _dereq_(33); // PhantomJS / old WebKit has a broken implementations
  ...
  157: [function (_dereq_, module, exports) {
    ...
    if (!(HAS_INSTANCE in FunctionProto)) _dereq_(75).f(FunctionProto, HAS_INSTANCE, {
  ...
  177: [function (_dereq_, module, exports) {
    ...
    if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
      ...
      for (var keys = _dereq_(36) ? gOPN(Base) : ( // ES3:
  ...
  185: [function (_dereq_, module, exports) {
    ...
    var $parseFloat = _dereq_(88); // 20.1.2.12 Number.parseFloat(string)
  ...
  186: [function (_dereq_, module, exports) {
    ...
    var $parseInt = _dereq_(89); // 20.1.2.13 Number.parseInt(string, radix)
  ...
  187: [function (_dereq_, module, exports) {
    ...
    $export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !_dereq_(42)(function () {
      // V8 ~ Android 4.3-
      $toFixed.call({});
    })), 'Number', {
  ...
  190: [function (_dereq_, module, exports) {
    var $export = _dereq_(40); // 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
  ...
  191: [function (_dereq_, module, exports) {
    var $export = _dereq_(40); // 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)


    $export($export.S + $export.F * !_dereq_(36), 'Object', {
      defineProperties: _dereq_(76)
    });
  }, {
    "36": 36,
    "40": 40,
  ...
  192: [function (_dereq_, module, exports) {
    var $export = _dereq_(40); // 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)


    $export($export.S + $export.F * !_dereq_(36), 'Object', {
      defineProperty: _dereq_(75).f
    });
  }, {
    "36": 36,
    "40": 40,
  ...
  206: [function (_dereq_, module, exports) {
    ...
    var $parseFloat = _dereq_(88); // 18.2.4 parseFloat(string)
  ...
  207: [function (_dereq_, module, exports) {
    ...
    var $parseInt = _dereq_(89); // 18.2.5 parseInt(string, radix)
  ...
  208: [function (_dereq_, module, exports) {
    ...
    Wrapper = _dereq_(30)[PROMISE]; // statics
  ...
  210: [function (_dereq_, module, exports) {
    ...
    var rConstruct = (_dereq_(46).Reflect || {}).construct; // MS Edge supports only 2 arguments and argumentsList argument is optional
  ...
  211: [function (_dereq_, module, exports) {
    ...
    var toPrimitive = _dereq_(119); // MS Edge has broken Reflect.defineProperty - throwing instead of returning false
  ...
  226: [function (_dereq_, module, exports) {
    ...
    var regExpExec = _dereq_(95); // @@match logic
  ...
  228: [function (_dereq_, module, exports) {
    ...
    var regExpExec = _dereq_(95); // @@search logic
  ...
  244: [function (_dereq_, module, exports) {
    ...
    var $at = _dereq_(105)(true); // 21.1.3.27 String.prototype[@@iterator]()
  ...
  254: [function (_dereq_, module, exports) {
    ...
    $Symbol[PROTOTYPE][TO_PRIMITIVE] || _dereq_(48)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf); // 19.4.3.5 Symbol.prototype[@@toStringTag]
  ...
  266: [function (_dereq_, module, exports) {
    ...
    var $WeakMap = module.exports = _dereq_(29)(WEAK_MAP, wrapper, methods, weak, true, true); // IE11 WeakMap frozen keys fix
  ...
  273: [function (_dereq_, module, exports) {
    ...
    var userAgent = _dereq_(124); // https://github.com/zloirock/core-js/issues/280
...
$(document).ready(function () {
  if (!document.createElement('svg').getAttributeNS) {
    ...
    svg.each(function (i, el) {
      var src = $(el).attr('src');
      $(el).attr('src', src.replace('.svg', '.png'));
    });
  }

  if ($('.js-reviews-slider').length) {
    var slider = tns({
      container: '.js-reviews-slider',
      items: 1,
      mode: 'gallery',
      controls: false,
      nav: false,
      onInit: function onInit(el) {
        $(el.container).removeClass('slider-preview');
      }
    });
  }

  $('.js-more-reviews').on('click', function () {
    slider.goTo('next');
  });
  ...
  $('.js-callback').magnificPopup({
    ...
    callbacks: {
      beforeOpen: function beforeOpen() {
        var initiator = $(this).get(0).st.el;
        var type = initiator.data('type');
        var container = $('#popup-callback');
        container.find('input[name="form_subject"]').val(type);
        container.find('.modal__subtitle').text(type);
      }
    }
  });
  $('.js-send-mail').submit(function () {
    //Change
    var th = $(this);
    $.ajax({
      type: "POST",
      ...
      setTimeout(function () {
        // Done Functions
        $('.js-callback').magnificPopup('close');
        th.trigger("reset");
      }, 1000);
    });
    return false;
  });
  initMask('.js-mask-phone');
  ...
  function initMask(selector) {
    ...
    $(selector).mask("+r (000) 000-00-00", options);
  }
});